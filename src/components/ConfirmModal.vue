<template>
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        <!-- Backdrop -->
        <div class="absolute inset-0 bg-black/40 dark:bg-black/60 backdrop-blur-sm" @click="handleCancel"></div>
        ...
        <div class="relative bg-white dark:bg-slate-800 w-full sm:w-[400px] sm:rounded-2xl rounded-t-2xl shadow-2xl dark:shadow-black/30 overflow-hidden animate-slide-up transition-colors duration-300">
          ...
          <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 dark:border-slate-700">
            ...
            <div 
              ...
              :class="type === 'danger' ? 'bg-red-50 dark:bg-red-900/30 text-red-500' : 'bg-amber-50 dark:bg-amber-900/30 text-amber-500'"
            >
          ...
          <div class="px-6 py-4 bg-gray-50 dark:bg-slate-900/50 border-t border-gray-100 dark:border-slate-700 flex justify-end gap-3">
            ...
            <button
              ...
              :class="type === 'danger' 
                ...
                : 'bg-gray-900 dark:bg-violet-600 text-white hover:bg-gray-800 dark:hover:bg-violet-500'"
            >
              {{ confirmText }}
            </button>
          </div>
