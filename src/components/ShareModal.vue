        ...
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100">
              <h3 class="text-xl font-semibold text-gray-900">Share Page</h3>
              <button
                @click="close"
            ...
            <div class="p-6 space-y-4">
              ...
              <div class="border border-gray-200 rounded-xl p-4">
                <div class="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h4 class="font-medium text-gray-900">Read-only Link</h4>
                    <p class="text-sm text-gray-500">Others can view but cannot edit.</p>
                  </div>
                </div>
                ...
                <div v-if="page.readonly_page_id" class="flex gap-2 mt-3">
                  ...
                  <button
                    ...
                    class="px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2"
                  >
              ...
              <div class="border border-gray-200 rounded-xl p-4">
                <div class="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h4 class="font-medium text-gray-900">Edit Link</h4>
                    <p class="text-sm text-gray-500">Others can view and edit.</p>
                  </div>
                </div>
